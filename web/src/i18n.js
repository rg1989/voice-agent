const translations = {
  ...
  '试听失败': 'Preview failed',
  '除了音色、聆听方式和人设，这里的改动都会重启 Gateway，正在进行的任务会中断。': 'Changes here restart the gateway and interrupt any task in progress, except the voice, listening and persona settings.',
  '聆听方式': 'Listening',
